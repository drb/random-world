var signatureX = (function() {
    ...
    collection = function (output, collections) {
        ...
        structCollections.forEach(function(collection) {
            ...
            maxMembers        = Math.ceil(Math.random() * 12); 
            collectionMembers = [];
