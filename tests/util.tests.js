    ...
    describe('check the permutation/combination checker does correct checks', function() {
        ...
        describe('should return the correct values for the permutations available', function(){
            ...
            it('should return 6', function () {
                const permutations = utils.setChecker.permutations(3, 2);
                expect(permutations)
                    .to.be.a('number')
                    .to.equal(6);
            });
            ...
            it('should return 210', function () {
                const permutations = utils.setChecker.permutations(7, 3);
                expect(permutations)
                    .to.be.a('number')
                    .to.equal(210);
            });
            ...
            it('should return 655,381,440', function () {
                const permutations = utils.setChecker.permutations(60, 5);
                expect(permutations)
                    .to.be.a('number')
                    .to.equal(655381440);
            });
        ...
        describe('should return the correct values for the combinations available', function(){
            ...
            it('small set - should return 3', function () {
                const combinations = utils.setChecker.combinations(3, 2);
                expect(combinations)
                    .to.be.a('number')
                    .to.equal(3);
            });
            ...
            it('large set - should return 27405', function () {
                const combinations = utils.setChecker.combinations(30, 4);
                expect(combinations)
                    .to.be.a('number')
                    .to.equal(27405);
            });
            ...
            it('massive set - should return 1,215,450', function () {
                const combinations = utils.setChecker.combinations(75, 4);
                expect(combinations)
                    .to.be.a('number')
                    .to.equal(1215450);
            });
